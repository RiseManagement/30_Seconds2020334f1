...
public class Piano : MonoBehaviour
{
    ...
    void PianoPlay()
    {
        if (Input.GetMouseButtonDown(0) && pianoplaycount < pianomaxCount)
        {
            ...
            {
                case "do":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[1];
                    break;
                case "re":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[2];
                    break;
                case "mi":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[3];
                    break;
                case "fua":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[4];
                    break;
                case "so":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[5];
                    break;
                case "ra":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[6];
                    break;
                case "si":
                    hit.collider.transform.root.GetComponent<SpriteRenderer>().sprite = keybord_sprite[7];
                    break;
            }
